...
set_property PULLDOWN false [get_ports {bin[1]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {bin[8]}]
set_property PACKAGE_PIN T3 [get_ports {bin[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin[9]}]
set_property PACKAGE_PIN T2 [get_ports {bin[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin[10]}]
set_property PACKAGE_PIN R3 [get_ports {bin[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin[11]}]
set_property PACKAGE_PIN W2 [get_ports {bin[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin[12]}]
set_property PACKAGE_PIN U1 [get_ports {bin[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bin[13]}]
